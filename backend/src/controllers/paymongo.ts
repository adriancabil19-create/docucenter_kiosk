...
import { PayMongoPaymentRequest, ApiResponse, PayMongoPaymentResponse } from '../types';
...
export class PayMongoController {
  ...
  async createPayment(req: Request, res: Response): Promise<void> {
    try {
      ...
      const transaction = await paymongoService.createPayment(paymentRequest);
      ...
      const response: PayMongoPaymentResponse = {
        success: true,
        data: {
          transactionId: transaction.transactionId,
  ...
  async checkPaymentStatus(req: Request, res: Response): Promise<void> {
    try {
      ...
      const transaction = await paymongoService.checkPaymentStatus(transactionId);
  ...
  async cancelPayment(req: Request, res: Response): Promise<void> {
    try {
      ...
      const success = await paymongoService.cancelPayment(transactionId, reason);
  ...
  async handleWebhook(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Process webhook
      const processed = await paymongoService.processWebhook(payload);
  ...
  async simulatePaymentSuccess(req: Request, res: Response): Promise<void> {
    try {
      ...
      paymongoService.simulatePaymentSuccess(transactionId);
  ...
  async simulatePaymentFailure(req: Request, res: Response): Promise<void> {
    try {
      ...
      paymongoService.simulatePaymentFailure(transactionId, reason || 'Test failure');
